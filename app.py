...
app = Flask(__name__, template_folder=os.getcwd())  # Usando o diretório atual para arquivos HTML
...
def index():
    ...
    return render_template("index.html", connected=connected)  # Aqui ainda usa o render_template, mas com novo caminho
